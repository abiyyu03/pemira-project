...
<body>
    <div dir="ltr" class="es-wrapper-color" lang="ID">
        <!--[if gte mso 9
                        ...
                        <tr>
                            <td align="center">
                                <table class="es-content-body" width="600" cellspacing="0" cellpadding="0"
                                    ...
                                    <tr>
                                        <td class="es-p20t es-p20b es-p20r es-p20l" style="background-color: #ffffff"
                                            bgcolor="#ffffff" align="left">
                                            <table class="es-left" cellspacing="0" cellpadding="0" align="left">
                                                <tr>
                                                    <td class="es-m-p0r es-m-p20b" width="180" valign="top"
                                                        align="center">
                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                            <tr>
